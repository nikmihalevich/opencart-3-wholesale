...
class ControllerProductProduct extends Controller {
    ...
    public function getWholesaleData() {
        ...
        if (isset($this->request->get['wholesale_status'])) {
            $wholesale_status = $this->request->get['wholesale_status'];
        } else {
            $wholesale_status = 0;
        }
        ...
        if ($product_info) {
            if ($wholesale_status) {
                $json['price'] = $this->currency->format($this->tax->calculate($product_info['wholesale_price'], $product_info['tax_class_id'], $this->config->get('config_tax')), $this->session->data['currency']);
            } else {
